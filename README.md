...
Short version: The buyer does Invite -> CheckAddress -> Send Funds -> Release in that order, and the merchant does AcceptInvite -> Send Goods -> RequestRelease in that order
